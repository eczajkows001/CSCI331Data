...
<html>
	...
	<body>
		...
		<h5 align='center' style='background-color:red'>H5 style='background-color:red'</h5>
		<h6 align='center' style='font-family:courier;'>H6 style='font-family:courier;'</h6>
		<p align='center' style='font-size:200%'>paragraph style='font-size:200%'</p>
	</body>
	<body>
		<div align='center'>
			...
			<div>
				...
				<ul>
					...
					<li style='float:right'><a href='AcceptDelivery.jsp'>Item 4</a></li>
				</ul>
			</div>
			<div>
